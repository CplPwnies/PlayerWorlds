...
Private Const WebAddress As String = "http://www.neoorpg.com/updates/update.txt"
...
' directorys you want such as \maps or \graphics.. ie..
    ...
    If IsDirectory(App.Path & "\gfx") = False Then
        MkDir App.Path & "\gfx"
    End If
